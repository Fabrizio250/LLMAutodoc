# Evaluation — ct-covid-no-grade-run1
...
|---|---|---|---|---|---|---|---|---|
| overall | 40 | 28 | 12 | 0.964 | 0.926 | 0.833 | 0.417 | 0.583 |
| tool | 18 | 18 | 0 | 1.0 | 1.0 |  |  |  |
| retrieval | 18 | 10 | 8 | 0.9 | 0.778 | 0.5 | 0.125 | 0.875 |
...
| FP_hallucination | HALLUCINATION (filled without evidence) | 7 |
| FN_missed | missed (wrong abstention) | 1 |
| TN_abstention | correct abstention | 5 |
...
| riskAssessment | retrieval | abstained | partial | missed (wrong abstention) | Generated text failed the faithfulness check; unsupported: To mitigate this, a weighted bi |
...
| featureEngineering | Data Pre-Processing | retrieval | abstained | absent | TN_abstention | CORRECT | False | orchestrator | 5 |
...
| riskAssessment | Data Risk Assessment | retrieval | abstained | partial | FN_missed | CORRECT | False | orchestrator | 5 |
