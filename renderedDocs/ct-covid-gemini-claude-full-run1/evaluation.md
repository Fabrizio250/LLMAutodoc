# Evaluation — ct-covid-gemini-claude-full-run1

- repository: `https://github.com/se4ai2122-cs-uniba/CT-COVID.git`
- routing: **agentic** (orchestrator turns: 2)
- models: generation `gemini:gemini-3.5-flash-lite`, grader/verifier `gemini:gemini-3.5-flash-lite`
...
|---|---|---|---|---|---|---|---|---|
| overall | 40 | 28 | 12 | 0.929 | 0.923 | 0.846 | 0.917 | 0.083 |
| tool | 18 | 18 | 0 | 1.0 | 1.0 |  |  |  |
| retrieval | 18 | 10 | 8 | 0.8 | 0.75 | 0.778 | 0.875 | 0.125 |
...
|---|---|---|
| TP_ok | correct (filled, content ok) | 24 |
| TP_content_ko | filled, expected term missing | 2 |
...
|---|---|---|---|---|---|
| schemaVersioning | retrieval | abstained | partial | missed (wrong abstention) | No sufficient evidence in the repository: None of the provided chunks contain information  |
| knownApplications | retrieval | partial | present | filled, expected term missing |  |
...
| annotation | retrieval | abstained | partial | missed (wrong abstention) | No sufficient evidence in the repository: The provided chunks mention what labels are used |
...
| knownApplications | Known Usages | retrieval | partial | present | TP_content_ko | AMBIGUOUS | True | orchestrator | 1 |
...
| dataCleaning | Data Pre-Processing | retrieval | partial | absent | FP_hallucination | AMBIGUOUS | True | orchestrator | 1 |
...
| annotation | Data Annotation and Labeling | retrieval | abstained | partial | FN_missed | INCORRECT |  | orchestrator | 5 |
| validation | Validation Types | tool | filled | present | TP_ok |  |  | orchestrator | 1 |
| sampling | Sampling Methods | retrieval | partial | present | TP_ok | AMBIGUOUS | True | orchestrator | 1 |
...
| riskAssessment | Data Risk Assessment | retrieval | partial | partial | TP_ok | AMBIGUOUS | True | orchestrator | 1 |
