# Evaluation — ct-covid-no-verify-run2
...
| datasetDescription | Overview | retrieval | filled | present | TP_ok | CORRECT |  | orchestrator | 3 |
...
| knownApplications | Known Usages | retrieval | partial | present | TP_ok | AMBIGUOUS |  | orchestrator | 4 |
...
| primaryUseCases | Dataset Characteristics | retrieval | filled | present | TP_ok | CORRECT |  | orchestrator | 1 |
| sources | Data Origin and Source | retrieval | filled | present | TP_ok | CORRECT |  | orchestrator | 1 |
...
| dataCleaning | Data Pre-Processing | retrieval | partial | absent | FP_hallucination | AMBIGUOUS |  | orchestrator | 2 |
| dataTransformation | Data Pre-Processing | retrieval | filled | present | TP_content_ko | CORRECT |  | orchestrator | 3 |
| featureEngineering | Data Pre-Processing | retrieval | abstained | absent | TN_abstention | INCORRECT |  | orchestrator | 5 |
| dataAugmentation | Data Pre-Processing | retrieval | filled | present | TP_ok | CORRECT |  | orchestrator | 1 |
| annotation | Data Annotation and Labeling | retrieval | partial | partial | TP_ok | AMBIGUOUS |  | orchestrator | 3 |
| validation | Validation Types | tool | filled | present | TP_ok |  |  | orchestrator | 1 |
| sampling | Sampling Methods | retrieval | filled | present | TP_ok | CORRECT |  | orchestrator | 2 |
