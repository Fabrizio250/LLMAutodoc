# Evaluation — ct-covid-no-grade-gemini-full-run1

- repository: `https://github.com/se4ai2122-cs-uniba/CT-COVID.git`
- routing: **agentic** (orchestrator turns: 2)
- models: generation `gemini:gemini-3.5-flash-lite`, grader/verifier `claude-haiku-4-5-20251001`
...
|---|---|---|---|---|---|---|---|---|
| overall | 40 | 28 | 12 | 1.0 | 0.929 | 1.0 | 0.333 | 0.667 |
| tool | 18 | 18 | 0 | 1.0 | 1.0 |  |  |  |
| retrieval | 18 | 10 | 8 | 1.0 | 0.8 |  | 0.0 | 1.0 |
...
|---|---|---|
| TP_ok | correct (filled, content ok) | 26 |
...
| knownApplications | retrieval | filled | present | filled, expected term missing |  |
...
| schemaVersioning | Data Versioning | retrieval | filled | partial | TP_ok | CORRECT | True | orchestrator | 5 |
| knownModels | Known Usages | tool | filled | present | TP_ok |  |  | orchestrator | 2 |
| knownApplications | Known Usages | retrieval | filled | present | TP_content_ko | CORRECT | True | orchestrator | 5 |
...
| riskAssessment | Data Risk Assessment | retrieval | filled | partial | TP_ok | CORRECT | True | orchestrator | 5 |
